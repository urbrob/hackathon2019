...
urlpatterns = [
    ...
    path(
        "api/groups/<user_pk>", views.UserGroupsListREST.as_view(), name="groups_read"
    ),
    path(
        "api/quizes/<user_pk>/<group_pk>",
        views.QuizListREST.as_view(),
        name="quizes_read",
    ),
    # APP views
    ...
    path(
        "group/<group_pk>/<quiz_pk>", views.quiz_menu_display, name="quiz_menu_display"
    ),
    path(
        "group/<group_pk>/<quiz_pk>/manage",
