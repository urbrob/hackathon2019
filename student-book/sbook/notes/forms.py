...
class QuestionDetailsForm(forms.Form):
    ...
    answer_1 = forms.CharField(widget=forms.TextInput(attrs={'class':'form-control'}), label='Poprawna odpowiedź')
    answer_2 = forms.CharField(widget=forms.TextInput(attrs={'class':'form-control'}), label='Zła odpowiedź 1')
    answer_3 = forms.CharField(widget=forms.TextInput(attrs={'class':'form-control'}), label='Zła odpowiedź 2')
    answer_4 = forms.CharField(widget=forms.TextInput(attrs={'class':'form-control'}), label='Zła odpowiedź 3')


class GroupDetailsForm(forms.Form):
    name = forms.CharField(widget=forms.TextInput(attrs={'class':'form-control'}), label='Nazwa grupy')
